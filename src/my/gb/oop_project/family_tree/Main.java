...
public class Main {
    public static void main(String[] args) {
        ...
        ft.addHuman(new Human(5,"Владимир","М","Аркадьевич", LocalDate.of(1947,2,4),null, 4, List.of(2),0,0));
        ...
        //ft.printParents(1); //печать данных о родителях ребенка по id ребенка
